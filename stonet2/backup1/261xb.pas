...
begin
  if p1<>0 then inbuff(p1,0);{nerovnosti na zk}
  if p1<>0 then putico(0,  0,640,100,640,zbuffer[0]);
  if p2<>0 then inbuff(p2,0);
  if p2<>0 then putico(0,100,640,100,640,zbuffer[0]);
  if p3<>0 then inbuff(p3,0);
  if p3<>0 then putico(0,200,640,100,640,zbuffer[0]);
  if p4<>0 then inbuff(p4,0);
  if p4<>0 then putico(0,300,640,100,640,zbuffer[0]);
end;
...
begin
  ...
  {buffers}
  getmem(zbuffer[0],64000*sizeof(byte));buffseg[0]:=seg(zbuffer[0]^);
  getmem(zbuffer[1],64000*sizeof(byte));buffseg[1]:=seg(zbuffer[1]^);
  getmem(zbuffer[2],64000*sizeof(byte));buffseg[2]:=seg(zbuffer[2]^);
  getmem(zbuffer[3],64000*sizeof(byte));buffseg[3]:=seg(zbuffer[3]^);
  getmem(zbuffer[4],64000*sizeof(byte));buffseg[4]:=seg(zbuffer[4]^);
{  getmem(zbuffer[5],64000);buffseg[4]:=seg(zbuffer[4]^);
  ...
  {getit(1,0);}  {sgetico(0,(co-1)*100,640,100,640,zbuffer[i]);}
  readkey;
  putico(0,  0,640,100,640,zbuffer[0]);
  putico(0,100,640,100,640,zbuffer[0]);
  putico(0,200,640,100,640,zbuffer[0]);
  putico(0,300,640,100,640,zbuffer[0]);
  {kurzor}
  x:=0;
  y:=0;
  s:=2;
