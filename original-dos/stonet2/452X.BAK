...
begin
  ...
  if (s=2) and (y=0) then
  begin
    if x=1 then inbuff(1);
    if x=2 then inbuff(2);
    if x=3 then inbuff(3);
  end;
  if (x=4) and (y=0) then
  begin
    if s=1 then inbuff(6);
    if s=2 then inbuff(4);
    if s=3 then inbuff(5);
    if s=4 then inbuff(7);
  end;
  putbuffer;
end;
